...
<head>
    ...
    <title>{{ config('app.name', 'MarketKing') }} - ChatBoot</title>
    ...
    @vite(['resources/css/app.css', 'resources/js/chatboot.js'])
    ...
    <div class="container">
        <header class="header">
            <div>
                ...
                <p class="subtitle">ChatBoot (tool calling: <span style="color: var(--accent-secondary);">search</span>)</p>
            </div>
        ...
        <div class="chat-shell">
            <div id="chat-messages" class="messages">
                <div class="message message-assistant">
                    Привет! Задай любой вопрос. Если нужно — я сделаю поиск по базе через tool <strong>search</strong>.
                </div>
            </div>
